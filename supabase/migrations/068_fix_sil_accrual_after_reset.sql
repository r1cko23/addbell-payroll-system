-- =====================================================
-- 068: Fix SIL accrual after year reset
--  - After year reset, employees >= 1 year should start accruing
--    from January 1st of the current year, not from their anniversary month
-- =====================================================
