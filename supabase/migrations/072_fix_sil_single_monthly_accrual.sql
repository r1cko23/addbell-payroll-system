-- =====================================================
-- 072: Fix SIL to accrue only ONCE per month
--  - Employees >= 1 year: Accrue ONCE on 1st of each month
--  - Employees < 1 year: Accrue ONCE on their hire date day each month
--  - No retroactive accrual - only from current year onwards
-- =====================================================
