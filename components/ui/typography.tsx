...
export function H3({ children, className, style }: TypographyProps) {
  return (
    <h3 className={cn("text-lg font-semibold", className)} style={style}>
      {children}
    </h3>
  );
}
...
export function H4({ children, className, style }: TypographyProps) {
  return (
    <h4 className={cn("text-base font-semibold", className)} style={style}>
      {children}
    </h4>
  );
}
...
export function Body({ children, className, style }: TypographyProps) {
  return (
    <p className={cn("text-base text-foreground", className)} style={style}>
      {children}
    </p>
  );
}
...
export function Label({ children, className, style }: TypographyProps) {
  return (
    <label className={cn("text-sm font-medium", className)} style={style}>
      {children}
    </label>
  );
}
