...
export const epFormCard = "w-full min-w-0 max-w-full";
...
export const epFormField =
  "w-full min-w-0 max-w-full space-y-2 [&_input.ios-temporal-input]:mb-0.5";
...
export const epFormGrid =
  "grid w-full min-w-0 max-w-full grid-cols-1 items-start gap-5 sm:gap-4 lg:grid-cols-2";
